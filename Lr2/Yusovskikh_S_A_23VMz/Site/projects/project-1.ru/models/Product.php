...
class Product
{
    ...
    public static function getProductsList()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name, price, image, code FROM product ORDER BY id ASC');
        $productsList = array();
        $i = 0;
        while ($row = $result->fetch()) {
            $productsList[$i]['id'] = $row['id'];
    ...
    public static function updateProductById($id, $options)
    {
        ...
        $result->bindParam(':image', $options['image'], PDO::PARAM_LOB);
    ...
    public static function createProduct($options)
    {
        ...
        $sql = 'INSERT INTO product '
            . '(name, image, price, category_id, brand, availability,'
            . 'description, is_new, is_recommended, status, code)'
            . 'VALUES '
            . '(:name, :image, :price, :category_id, :brand, :availability,'
    ...
    public static function getImage($id)
    {
        ...
        return  '<img class="card-img-top" src="data:image/jpeg;base64,' . base64_encode($product['image']) . '"/>';
    }
