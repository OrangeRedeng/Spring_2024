            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <?php echo '<img class="card-img-top" style="max-height: auto;" src="data:image/jpeg;base64,' . base64_encode($product['image']) . '"/>'; ?>
...
<?php include ROOT . '/template/layouts/footer_admin.php'; ?>
